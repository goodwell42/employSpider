...
public class App {
	...
	public static void main(String[] args) {
		...
		// 筛选出Java开发相关招聘
		String queryCondition = "&pageSize=90&cityId=489&workExperience=-1&education=-1&companyType=-1&employmentType=-1&jobWelfareTag=-1&kw=Java%E5%BC%80%E5%8F%91&kt=3&_v=0.30785769&x-zp-page-request-id=e0c803d3440f4b1bbc46fd19220028ec-1545727594478-118071";
			
		for (int i = 1; i <= 5; i++) {
			String url = String.format("%s%d%s", path, i, queryCondition);
